...
if __name__ == '__main__':
    # execute(symbol='688981', PHI=0.001, TICK_SIZE=0.01, fee_rate=0.00005, use_fee=True, use_arl=False)
    execute(symbol='510300', PHI=0.0001, TICK_SIZE=0.001, fee_rate=0.0000, use_fee=False, use_arl=True)